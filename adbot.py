    ...
    def get_message(self, key, **kwargs):
        messages = {
            "fa": {
                ...
                "invalid_command": "دستور نامعلوم برای دیدن دستورات بات از !help استفاده کنید",
    ...
    async def on_chat(self, user: User, message: str):
        ...
        try:
            ...
            if msg_lower in self.emotes:
                ...
                await self.highrise.chat("👑 سازنده این بات: @roz.ihank 👑")
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "https://high.rs/world?id=6894bd39e3e4a405517cb530&ownedRoomId=692043a4ec047ded459be162&invite_id=6a97bc0a917a9ff24e81fc96")
    api_token = os.getenv("API_TOKEN", "ca5c7a9c7cf6bdb12042b9cad01c215ceb2dd2198b7445c2f2ac71c923f8a0f6")
