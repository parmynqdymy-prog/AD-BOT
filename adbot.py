...
DEFAULT_CONFIG = {
    "host_usernames": ["ROZ.IHANK"],["77.77.78"]
    "admin_usernames": ["77.77.78"],["77.77.81"]
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
    ...
    def get_message(self, key, **kwargs):
        messages = {
            "fa": {
                ...
                "invalid_command": "دستور نامعلوم . برای دیدن دستورات !help را امتحان کنید",
    ...
    async def on_chat(self, user: User, message: str):
        ...
        try:
            ...
            if msg_lower in self.emotes:
                ...
                await self.highrise.chat("👑 سازنده این بات: @77.77.78 👑")
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "692043a4ec047ded459be162")
    api_token = os.getenv("API_TOKEN", "8447ae6050a7dc051570b4b1642e92d936aa7e34ddc1fae3daf9e9855af724f0")
